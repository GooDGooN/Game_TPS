...
public class EnemyProperty : CharacterProperty
{
    ...
    protected virtual void FixedUpdate()
    {
        ...
        Physics.BoxCast(transform.position + new Vector3(0.0f, capsuleColliderHeight, 0.0f), new Vector3(0.4f, 0.01f, 0.4f), Vector3.down, out var info, Quaternion.identity, float.PositiveInfinity, GlobalVarStorage.Instance.SolidLayer);
    ...
    {
        if ((1 << other.gameObject.layer & GlobalVarStorage.Instance.PlayerLayer) != 0)
        {
